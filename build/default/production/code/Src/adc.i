...
sideparm gside[3U] =
{
    {1,{0.0f},&gside[0].sidebuff[0], 0.0f},
    {1,{0.0f},&gside[1].sidebuff[0], 0.0f},
    {1,{0.0f},&gside[2].sidebuff[0], 0.0f}
};

adc_handle_t adc[] =
{
    {0x0E, 0x00, &gside[0], 0, 0U},
    {0x0F , 0x00, &gside[1], 0, 0U},
    {0x11 , 0x00, &gside[2], 0, 0U}
};
...
adc_result_t ADC_GetConversion(adc_channel_t channel)
{
    ...
    return (((adc_result_t)((ADRESH << 8) + ADRESL)) & 0x3FF);
}

void ADC_TemperatureAcquisitionDelay(void)
{
    _delay((unsigned long)((200)*(44236800/4000000.0)));
}
